                ...
                cellSpacing="0" width="100%">
                  ...
                  <thead>
                    <tr>
                      ...
                      className="white-text templatemo-sort-by">
                      Medicine description <span className="caret"></span></a>
                      </th>
                      <th><a onClick={() => sortTable(4)} 
                      className="white-text templatemo-sort-by">
                      Ingredients <span className="caret"></span></a>
                      </th>
                      <th><a onClick={() => sortTable(5)}  
                      className="white-text templatemo-sort-by">
                      Format <span className="caret"></span></a>
                      </th>
                      <th ><a onClick={() => sortTable(6)}  
                      className="white-text templatemo-sort-by">
                      Prescription <span className="caret"></span></a>
                      </th>
                      <th><a onClick={() => sortTable(7)}  
                      className="white-text templatemo-sort-by">
                      Tablet <span className="caret"></span></a>
                      </th>
                      <th><a onClick={() => sortTable(8)}  
                      className="white-text templatemo-sort-by">
                      Dosage <span className="caret"></span></a>
                      </th>
                      <td>Action</td>
                    </tr>
                 </thead>
