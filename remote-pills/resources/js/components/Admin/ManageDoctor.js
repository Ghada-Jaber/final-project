    ...
    return medicine.map(medicine => {
      return(
        <tr key={medicine.id}>
          ...
          <td>{medicine.name}</td>
          <td>
           {medicine.street.name}, {medicine.street.city.name}, {medicine.street.city.country.name}
          </td>
          ...
          <td style={{ textAlign:'center'}}>
            <div className="btn-group " role="group">
              ...
              className="btn btn-info" title="Show">
              ...
              {medicine.active ==1 ? 
                  ...
                  className="btn btn-default" title="Deactivate">
                    <i className="fa fa-trash fa-fw"></i>
                  </a>
                : 
                <a  onClick= {() => handleActiveUser(medicine.id)}
                  className="btn btn-default" title="Activate">
