    ...
    return(
      <ul className="nav navbar-nav" >
        ...
        <li className= {`${(page =='/manageMedicine') ? 'active' : '' }`}>
          ...
          <i className="fa fa-medkit fa-fw"></i>Manage Medicines</a>
        </li>
      </ul>
    )
  }
    ...
    return(
      <ul className="nav navbar-nav" >
        <li className= {`${(page =='/buy') ? 'active' : '' }`}>
          <a href="/buy"><i className="fa fa-medkit fa-fw"></i>Medicines</a>
        </li>

        <li className= {`${(page =='/doctor') ? 'active' : '' }`}>
          <a href="/doctor"><i className="fa fa-user-md fa-fw"></i>Doctors</a>
        </li>                  
        <li className= {`${(page =='/cart') ? 'active' : '' }`}>
          <a href="/cart"><i className="fa fa-shopping-bag fa-fw"></i>Cart</a>
        </li>
      </ul>
    )
  }
              ...
              <div style={{ display:'flex', flexFlow: 'row wrap'}}>
                ...
                <div style={{ display:'flex', flexFlow: 'column wrap'}}>
                  ...
                  <li className="nav-item dropdown">
                    ...
                    <div className="dropdown-menu menuwidth" style={{ padding: '12px'}} aria-labelledby="navbarDropdown">
                      <ul>
