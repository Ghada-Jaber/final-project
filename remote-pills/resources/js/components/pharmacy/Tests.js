...
function handleSelectChange(event){
 ...
 {order.buy.length > 0 ?  
  <div className="templatemo-content-widget no-padding white-bg  text-center item mb-4" >
            <br/>
           
            <h3 className="text-dark">
            <a data-toggle="collapse" data-parent="#accordion" href={`#customer${order.id}`}>{order.customer.name}</a>
            </h3>
      ...
      function renderReservation(){
        return reserve.map(order => {
            return(
              ...
              <h3 className="text-dark">
              <a data-toggle="collapse" data-parent="#accordion" href={`#reserve${order.id}`}>{order.customer.name}</a>
          </h3>
